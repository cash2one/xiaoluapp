...
//查询数据总数
$video_category_video_list_count_key = 'mzw_video_category_video_list_count_'.$mydata['gameid'].'_'.$mydata['categoryid'].'_'.$mydata['typeid']; //专辑视频总数缓存key  'mzw_video_category_video_list_count_' + 游戏id + 专辑id + 视频类型id
...
//获取专辑视频数据
$video_category_video_list_data_key = 'mzw_video_category_video_list_data_'.$mydata['gameid'].'_'.$mydata['categoryid'].'_'.$mydata['typeid'].'_'.$mydata['pagenum'].'_'.$mydata['pagesize']; //专辑视频数据缓存key  'mzw_video_category_video_list_data_' + 游戏id + 专辑id + 视频类型id + 当前页 + 每页显示数据
$data = $mem_obj->get($video_category_video_list_data_key); //专辑视频数据
if($data === false){
