<?php
/*=============================================================================
#     FileName: tmp_action_export.video_vert_common.count.in.php
#         Desc: 视频广告每天凌晨将两天前的数据导入到对应月的表中
#       Author: Chen Zhong
#        Email: chenzhong@kuaiyouxi.com
#   LastChange: 2015-09-17 15:02:35
#      History:
=============================================================================*/
//TODO
//这个程序需要注意可能会出现多天的数据
...
include_once("../video_vert.event.config.inc.php"); //归档参数配置
        ...
        if(!empty($val['is_export'])){
            ...
            if($data && isset($data[0])){
                ...
                $str_check_sql = "CREATE TABLE IF NOT EXISTS `".$val['db_name']."_".$row['month']."` (
                  ...
                  `".$val['field_pre']."_bd` varchar(100) NOT NULL COMMENT '品牌',
                  ...
                  `".$val['field_pre']."_title` varchar(100) DEFAULT NULL COMMENT 'APP或游戏标题',
                  `".$val['field_pre']."_adtitle` varchar(200) DEFAULT NULL COMMENT '广告标题',
                  ...
                  `".$val['field_pre']."_adid` int(11) NOT NULL DEFAULT '0' COMMENT '广告位id',
                  `".$val['field_pre']."_source` tinyint(1) NOT NULL DEFAULT '0' COMMENT '访问来源（1：app 2：SDK）'
            ";
